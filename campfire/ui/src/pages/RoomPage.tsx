...
export default function RoomPage() {
  ...
  const {
    peers, localStream, messages, audioEnabled, videoEnabled, screenSharing,
    sendMessage, toggleAudio, toggleVideo, toggleScreenShare, cleanup,
      ...
      <div className="flex-1 flex overflow-hidden">
        <div className="flex-1 relative">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-stone-900/90 backdrop-blur border border-stone-700/50 rounded-full px-4 py-2 shadow-xl">
            ...
            <Btn active={screenSharing} onClick={toggleScreenShare} accent={screenSharing}><ScreenIco /></Btn>
